...
const firebaseAdmin_1 = require("./firebaseAdmin"); // Importa la instancia de Storage centralizada
/**
...
exports.processPaymentFile = (0, storage_1.onObjectFinalized)({ region: "southamerica-east1" }, async (event) => {
    ...
    if (!contentType || !contentType.startsWith('text/csv') || !filePath || !filePath.startsWith('uploads/')) {
        firebase_functions_1.logger.log('Archivo no es CSV o no está en /uploads. Se ignora.', { filePath, contentType });
        return;
    }
