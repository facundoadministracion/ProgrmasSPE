              ...
              <UICard className={`${programName !== PROGRAMAS.TUTORIAS ? 'lg:col-span-2' : ''}`}>
                  ...
                  <CardContent>
                      <div className="overflow-y-auto max-h-60 border rounded-lg">
                          <Table>
                              <TableHeader className="bg-gray-50 sticky top-0"><TableRow><TableHead>Tipo</TableHead><TableHead>Nombre</TableHead><TableHead>Detalle</TableHead><TableHead className="text-right">Acción</TableHead></TableRow></TableHeader>
                              <TableBody>
